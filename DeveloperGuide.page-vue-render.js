...
with(this){return _c('p',[_v("Finally, here are the command classes in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" used to represent the different types of commands:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Since there are many types of Find Command classes with similar functionality, they all extend an abstract parent class "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AbstractFindCommand")]),_v(", used to contain most of the common methods.")]),_v(" "),_c('li',[_v("Each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" class contains the respective "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("COMMAND_WORD")]),_v(" representing the name of the command and a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MESSAGE_USAGE")]),_v(" string to demonstrate how to use the respective command.")]),_v(" "),_c('li',[_v("Additionally, each Find Command class ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByNameCommand")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByEmailCommand")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByTagCommand")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindByPhoneCommand")]),_v(") contains a respective "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("COMMAND_WORD")]),_v(" (\""),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("n/")]),_v("\", \""),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("e/")]),_v("\", \""),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t/")]),_v("\" and \""),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("p/")]),_v("\" respectively) on top of the shared command word \""),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v("\" to be used.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 4 Nov 2024, 22:42:32 GMT+8]")])])])}
}];
