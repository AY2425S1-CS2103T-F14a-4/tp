...
with(this){return _c('p',[_c('strong',[_v("Target user profile")]),_v(":  university students")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Feature")]),_v(" "),_c('th',[_v("Description")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("Clustering of tags")]),_v(" "),_c('td',[_v("Group tags of the same categories together in the UI's display of the tags list.")])]),_v(" "),_c('tr',[_c('td',[_v("Pin contacts")]),_v(" "),_c('td',[_v("Keep selected contacts constantly shown at the top of the contacts list.")])]),_v(" "),_c('tr',[_c('td',[_v("Customize category colors")]),_v(" "),_c('td',[_v("Change the colors of the categories to the user's preference.")])]),_v(" "),_c('tr',[_c('td',[_v("Multiple numbers per contact")]),_v(" "),_c('td',[_v("Allow more than one number per contact to accommodate multiple contact numbers.")])]),_v(" "),_c('tr',[_c('td',[_v("Custom fields for contacts")]),_v(" "),_c('td',[_v("Add custom fields to the contacts added.")])]),_v(" "),_c('tr',[_c('td',[_v("Custom shortcut commands")]),_v(" "),_c('td',[_v("Add custom shortcut commands to streamline actions within the application.")])]),_v(" "),_c('tr',[_c('td',[_v("Delete tag from all contacts")]),_v(" "),_c('td',[_v("Remove a specific tag from all contacts at once.")])]),_v(" "),_c('tr',[_c('td',[_v("Dark mode")]),_v(" "),_c('td',[_v("Include a dark mode theme for easier viewing in low light conditions.")])]),_v(" "),_c('tr',[_c('td',[_v("Copy contact information")]),_v(" "),_c('td',[_v("Enable copying of contact information to reduce errors from manual copying.")])]),_v(" "),_c('tr',[_c('td',[_v("Export contacts")]),_v(" "),_c('td',[_v("Provide an option to export contact information for easier sharing.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 7 Nov 2024, 22:46:35 GMT+8]")])])])}
}];
