...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/se-edu/CampusConnect/tree/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/se-edu/CampusConnect/tree/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Finally, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" contains the important "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" classes. Some command classes from AB3 have been retained:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" class (old and new) extends from the abstract "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" class, which enforces the implementation of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute()")]),_v(" method.")]),_v(" "),_c('li',[_v("Each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" class contains the respective "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("COMMAND_WORD")]),_v(" representing the name of the command and a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MESSAGE_USAGE")]),_v(" string to demonstrate how to use the respective command.")]),_v(" "),_c('li',[_v("They also contain their own respective error messages.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/se-edu/CampusConnect/tree/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCampusConnect#saveCurrentData()")]),_v(" — Saves the current CampusConnect state in its future.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCampusConnect#saveOldData()")]),_v(" — Saves the current CampusConnect state in its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCampusConnect#extractOldData()")]),_v(" — Restores the previous CampusConnect state from its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCampusConnect#extractUndoneData()")]),_v(" — Restores a previously undone CampusConnect state from its history.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("These operations are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#saveCurrentCampusConnect()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoCampusConnect()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redoCampusConnect()")]),_v(" respectively.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application for the first time. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCampusConnect")]),_v(" will be initialized with two stacks.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command to delete the 5th person in the CampusConnect. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#saveCurrentCampusConnect()")]),_v(", causing the modified state of the CampusConnect after the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command executes to be displayed and the old state of CampusConnect to be saved to the history.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Saves the entire CampusConnect.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: May have performance issues in terms of memory usage.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Each command that changes the state stores the change that it has made.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Will use less memory (e.g. for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", just save the person being deleted).")]),_v(" "),_c('li',[_v("Cons: Difficult and tedious to implement.")])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Target user profile")]),_v(":  NUS undergraduate students")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("manage contacts faster than a typical mouse/GUI driven app")]),_v(" "),_c('li',[_v("can connect people in the same modules/class/clubs/hobby, creating an active environment.")]),_v(" "),_c('li',[_v("make it easier for users to look for contacts of profs and teaching staff.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CampusConnect")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC01 - Add a person's contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect adds new contact to contact list.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect displays success message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Input format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. CampusConnect shows error message.")])]),_v(" "),_c('li',[_c('p',[_v("1b1. User enters input again.")]),_v(" "),_c('p',[_v("Steps 1a1-1a2 repeat until input format is valid.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. Another contact with the same name and contact number exists in the list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. CampusConnect shows error message.")])]),_v(" "),_c('li',[_c('p',[_v("1b2. User enters input again.")]),_v(" "),_c('p',[_v("Steps 1b1-1b2 repeat until input format is valid.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC02 - Delete a person's contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect finds and deletes contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect displays success message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Input format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. CampusConnect shows error message.")])]),_v(" "),_c('li',[_c('p',[_v("1a2. User enters input again.")]),_v(" "),_c('p',[_v("Steps 1a1-1a2 repeat until input format is valid.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. Contact to delete does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. CampusConnect shows error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC03 - Find a person's contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect searches the contact list and displays the details of the contact found.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add tags to a contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect searches the contact list and finds the correct contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect adds tags to the contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect displays success message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Input format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. CampusConnect shows error message.")])]),_v(" "),_c('li',[_c('p',[_v("1a2 User enters input again.")]),_v(" "),_c('p',[_v("Steps 1a1-1a2 repeat until input format is valid.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. Tag already exists for the contact")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. CampusConnect shows error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use cases: UC05 - Delete a tag from a contact")]),_v(" "),_c('strong',[_v("Precondition")]),_v(": Contact to delete a tag from already exists")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete a specific tag from a contact")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect searches the contact list and finds the correct contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect deletes the specific tag from the contact")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect displays success message")]),_v(" "),_c('p',[_v("Use case ends")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Input format is invalid")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. CampusConnect shows error message.")])]),_v(" "),_c('li',[_c('p',[_v("1a2 User enters input again.")]),_v(" "),_c('p',[_v("Steps 1a1-1a2 repeat until input format is valid.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. The contact does not contain the tag user wants to delete")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. CampusConnect shows error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use cases: UC06 - Undo an execution of command")]),_v(" "),_c('strong',[_v("Precondition")]),_v(": At least one valid command has been executed by the user.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to undo the most recent command execution.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect reverts the most recent command, restoring the data to its previous state\nbefore the command was executed.")]),_v(" "),_c('p',[_v("Use case ends")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Precondition: The user has previously undone at least one command.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("The user requests to redo the most recently undone command.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect restores the data to the state it was in immediately before the undo.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("GUI")]),_v(": The "),_c('em',[_v("Graphical User Interface")]),_v(", through which the user can input commands and view contacts and tags.")]),_v(" "),_c('li',[_c('strong',[_v("Field")]),_v(": An attribute possessed by a contact, namely Phone number, Tags, Name and Email.")]),_v(" "),_c('li',[_c('strong',[_v("Prefix")]),_v(": An identifier used in commands to indicate which field is referred to. For the 4 fields Phone, Name, Tags and Email,\nthe "),_c('em',[_v("prefixes")]),_v(" would be "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("p/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("n/")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("e/")]),_v(" respectively.")]),_v(" "),_c('li',[_c('strong',[_v("Duplicate Contact")]),_v(": A contact that has the same Phone, Email and Name as another contact.")]),_v(" "),_c('li',[_c('strong',[_v("Tag List")]),_v(": The scrollable list in the GUI displaying all unique tags and their colour-coded categories.")]),_v(" "),_c('li',[_c('strong',[_v("Person List")]),_v(": The scrollable list of contacts in the GUI displaying all contacts and the respective values for their fields.")]),_v(" "),_c('li',[_c('strong',[_v("Commands affected by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")])]),_v(": These refer to all commands that affect the "),_c('em',[_v("state")]),_v(" of the Tag List and Contact List\nin "),_c('strong',[_v("CampusConnect")]),_v(" and exclude "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(", as they do not alter the state of the contact or tag list.")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',{staticStyle:{"text-align":"center"}},[_v("Feature")]),_v(" "),_c('th',[_v("Description")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Clustering of tags")]),_v(" "),_c('td',[_v("Group tags of the same categories together in the UI's display of the tags list.")])]),_v(" "),_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Pin contacts")]),_v(" "),_c('td',[_v("Keep selected contacts constantly shown at the top of the contacts list.")])]),_v(" "),_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Customize category colors")]),_v(" "),_c('td',[_v("Change the colors of the categories to the user's preference.")])]),_v(" "),_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Multiple numbers per contact")]),_v(" "),_c('td',[_v("Allow more than one number per contact to accommodate multiple contact numbers.")])]),_v(" "),_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Custom fields for contacts")]),_v(" "),_c('td',[_v("Add custom fields to the contacts added.")])]),_v(" "),_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Custom shortcut commands")]),_v(" "),_c('td',[_v("Add custom shortcut commands to streamline actions within the application.")])]),_v(" "),_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Delete tag from all contacts")]),_v(" "),_c('td',[_v("Remove a specific tag from all contacts at once.")])]),_v(" "),_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Dark mode")]),_v(" "),_c('td',[_v("Include a dark mode theme for easier viewing in low light conditions.")])]),_v(" "),_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Copy contact information")]),_v(" "),_c('td',[_v("Enable copying of contact information to reduce errors from manual copying.")])]),_v(" "),_c('tr',[_c('td',{staticStyle:{"text-align":"center"}},[_v("Export contacts")]),_v(" "),_c('td',[_v("Provide an option to export contact information for easier sharing.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Our first major change was to modify the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command to accept any field as a parameter and allow multiple parameters. This was a moderate effort\nthat required us to change how the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(" class worked by creating new predicate classes and processing the logic for that as well,\nwhich was aided by the given predicate classes that we used as a template, but it was not trivial.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Our next major change was the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(" commands, which were quite extensive to implement. We had to create the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCampusConnect")]),_v(" (a\nvariation on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook")]),_v(") and resolve serious issues related to the undo and redo state, such as logic to process\nwhen the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(" commands failed and whether non-state affecting commands (like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(") would affect the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(" result. Overall,\nthis was quite difficult.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Finally, our last major change was the tag management and categorisation system, which was more difficult as the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(". We added a tag management\ncomponent and several commands, different types of tags, and a tag list component in the UI. Figuring out how to dynamically update the tags and the tag list\nin the GUI required a restructuring of our GUI files (under the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ui")]),_v(" folder) and we had faced many issues with the tag categorisation system. All in all,\nimplementing this system was not easy but it did provide better tag customisation and control than AB3.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 7 Nov 2024, 23:15:50 GMT+8]")])])])}
}];
