...
with(this){return _c('p',[_c('strong',[_v("Use case: UC04 - Add notes to a contact")]),_c('br'),_v(" "),_c('strong',[_v("Precondition")]),_v(": Contact to add notes to already exists")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add notes to a contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect searches the contact list and finds the correct contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect add notes to the contact.")])]),_v(" "),_c('li',[_c('p',[_v("CampusConnect displays success message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Input format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. CampusConnect shows error message.")])]),_v(" "),_c('li',[_c('p',[_v("1a2 User enters input again.")]),_v(" "),_c('p',[_v("Steps 1a1-1a2 repeat until input format is valid.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. Note already exists for the contact")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. CampusConnect deletes old note from the contact.")])]),_v(" "),_c('li',[_c('p',[_v("1b2. CampusConnect adds new note for the contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 24 Oct 2024, 23:28:24 GMT+8]")])])])}
}];
